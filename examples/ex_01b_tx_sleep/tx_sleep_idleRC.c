/*! ----------------------------------------------------------------------------
 *  @file    tx_sleep_idleRC.c
 *  @brief   TX with sleep example code, here the auto INIT2IDLE bit is cleared. This means the
...
LOG_MODULE_REGISTER(tx_sleep_idlerc);

/* Example application name and version to display on LCD screen. */
#define APP_NAME "TX SLEEP IDLE_RC v1.0"

/* Default communication configuration. We use default non-STS mode. */
