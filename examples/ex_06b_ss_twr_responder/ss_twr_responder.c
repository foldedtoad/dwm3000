...
/* Length of the common part of the message (up to and 
 * including the function code, see NOTE 3 below). */
...
/* Values for the PG_DELAY and TX_POWER registers reflect the 
 * bandwidth and power of the spectrum at the current
 * temperature. These values can be calibrated prior to taking 
 * reference measurements. See NOTE 5 below. */
...
int app_main(void)
{
     ...
     * help debug, and also TX/RX LEDs
