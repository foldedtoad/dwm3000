...
pushd .; cd ex_00a_reading_dev_id           ; ./configure.sh; cd build; make; popd
...
pushd .; cd ex_01g_simple_tx_sts_sdc        ; ./configure.sh; cd build; make; popd
pushd .; cd ex_01h_simple_tx_pdoa           ; ./configure.sh; cd build; make; popd
pushd .; cd ex_01i_simple_tx_aes            ; ./configure.sh; cd build; make; popd
...
pushd .; cd ex_02f_rx_with_crystal_trim     ; ./configure.sh; cd build; make; popd
pushd .; cd ex_02g_simple_rx_sts_sdc        ; ./configure.sh; cd build; make; popd
pushd .; cd ex_02h_simple_rx_pdoa           ; ./configure.sh; cd build; make; popd
pushd .; cd ex_02i_simple_rx_aes            ; ./configure.sh; cd build; make; popd
...
pushd .; cd ex_05c_ds_twr_init_sts_sdc      ; ./configure.sh; cd build; make; popd
pushd .; cd ex_05d_ds_twr_resp_sts_sdc      ; ./configure.sh; cd build; make; popd
pushd .; cd ex_06a_ss_twr_initiator         ; ./configure.sh; cd build; make; popd
pushd .; cd ex_06b_ss_twr_responder         ; ./configure.sh; cd build; make; popd
pushd .; cd ex_06e_AES_ss_twr_initiator     ; ./configure.sh; cd build; make; popd
pushd .; cd ex_06f_AES_ss_twr_responder     ; ./configure.sh; cd build; make; popd
pushd .; cd ex_07a_ack_data_tx              ; ./configure.sh; cd build; make; popd
pushd .; cd ex_07b_ack_data_rx              ; ./configure.sh; cd build; make; popd
pushd .; cd ex_07c_ack_data_rx_dbl_buff     ; ./configure.sh; cd build; make; popd
pushd .; cd ex_11a_spi_crc                  ; ./configure.sh; cd build; make; popd;
pushd .; cd ex_13a_gpio                     ; ./configure.sh; cd build; make; popd
pushd .; cd ex_14a_otp_write                ; ./configure.sh; cd build; make; popd
pushd .; cd ex_15a_le_pend_tx               ; ./configure.sh; cd build; make; popd
pushd .; cd ex_15b_le_pend_rx               ; ./configure.sh; cd build; make; popd
